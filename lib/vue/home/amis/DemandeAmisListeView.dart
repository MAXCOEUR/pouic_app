...
class _DemandeAmisListeViewState extends State<DemandeAmisListeView> {
  ...
  void _onScroll() {
    if (_scrollController.position.atEdge &&
      ...
      userController!.addDemande_inListe(page, "", reponseUpdate,reponseError);
  ...
  void deleteDemandeAmis(User user,bool accept){
    if(accept) {
      userCreate.addAmis(user, reponseValideDemandeAmis,reponseError);
    } else {
      userCreate.refuseDemandeAmis(user, reponseDeleteDemandeAmis,reponseError);
    }
  }
  ...
  void reponseValideDemandeAmis(User u){
    setState(() {
      userController!.deleteUser(u);
    });
  }
